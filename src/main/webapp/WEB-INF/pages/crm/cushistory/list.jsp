...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../cushistory/preAdd" target="navTab"><span>添加</span></a></li>
		...
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td>
					...
					<a title="编辑" target="navTab" href="../cushistory/preUpdate/${cushistory.historyId }" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
