...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../contract/preAdd3" target="navTab"><span>添加</span></a></li>
	...
	<table class="list" width="1200" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td><img src="../show/${contract.picPath }" height="100"/></td>
				<td>
					<a title="删除" target="ajaxTodo" href="../contract/doDelete/${contract.contractId }" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="../contract/preUpdate3?contractId=${contract.contractId }" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
