...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../contract/preAdd2" target="navTab"><span>添加</span></a></li>
		...
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td>
					...
					<a title="编辑" target="navTab" href="../contract/preUpdate2?contractId=${contract.contractId }" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
