...
<form id="pagerForm" method="post" action="../contract/listAll">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../contract/preAdd" target="navTab"><span>添加</span></a></li>
	...
	<table class="list" width="1200" layoutH="138">
		<thead>
			<tr>
				...
				<th width="120" orderField="accountNo" class="asc">合同ID</th>
				<th orderField="accountName">合同名称</th>
				<th width="80" orderField="accountType">合同时间</th>
				<th width="130" orderField="accountCert">合同地点</th>
				<th width="60" align="center" orderField="accountLevel">合同签署人</th>
				<th width="70">客户人</th>
				<th width="70">合同金额</th>
				<th width="70">合同归属团队</th>
				<th width="70">合同图片</th>
				<th width="70">操作</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td>${contract.customer.cusName }</td>
				<td>${contract.money }</td>
				<td>${contract.team.teamName }</td>
				<td><a href="../upload/${contract.picPath }"><img src="../show/${contract.picPath }" height="100"/></a></td>
				<td>
					<a title="删除" target="ajaxTodo" href="../contract/doDelete/${contract.contractId }" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="../contract/preUpdate/${contract.contractId }" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
