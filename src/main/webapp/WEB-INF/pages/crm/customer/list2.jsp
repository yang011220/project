...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../customer/preAdd2" target="navTab"><span>添加</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		<thead>
			<tr>
				...
				<th width="120" orderField="accountNo" class="asc">客户ID</th>
				<th orderField="accountName">客户名称</th>
				<th width="80" orderField="accountType">客户类型</th>
				<th width="130" orderField="accountCert">客户年龄</th>
				<th width="60" align="center" orderField="accountLevel">客户地址</th>
				<th width="70">客户公司</th>
				<th width="70">客户职位</th>
				<th width="70">客户归属人</th>
				<th width="70">客户状态</th>
				<th width="70">客户标签</th>
				<th width="70">操作</th>
			</tr>
		...
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td>${customer.custype.cusType }</td>
				<td>${customer.cusAge }</td>
				<td>${customer.cusLocation }</td>
				<td>${customer.cusCompany }</td>
				<td>${customer.cusPosition }</td>
				<td>${customer.emp.empName }</td>
				<td>${customer.cusstate.stateName }</td>
				<td>${customer.custag.tagtype.tagtypeName }:${customer.custag.tagName }</td>
				<td>
					<a title="删除" target="ajaxTodo" href="../customer/doDelete/${customer.cusId }" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="../customer/preUpdate2?cusId=${customer.cusId }" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
