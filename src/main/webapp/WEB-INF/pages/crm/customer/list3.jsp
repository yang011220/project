...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../customer/preAdd3" target="navTab"><span>添加</span></a></li>
		...
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td>
					...
					<a title="编辑" target="navTab" href="../customer/preUpdate3?cusId=${customer.cusId }" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
