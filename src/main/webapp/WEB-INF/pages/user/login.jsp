		...
		<div id="login_content">
			<div class="loginForm">
				<form>
					<p>
						<label>用户名：</label>
						<input type="text" id="username" name="username" size="20" class="login_input" minlength="3" maxlength="20" class="required" />
					</p>
					<p>
						<label>密码：</label>
						<input type="password" id="password" name="password" size="20" class="login_input" minlength="3" maxlength="20" class="required" />
					</p>
				</form>
				<div class="login_bar">
